...
RSpec.describe 'runs/index', type: :view do
  before(:each) do
    ...
    @started_run_1 = build_stubbed(:started_run, started_at: 17.days.ago)
    @ended_run_1 = build_stubbed(:ended_run, score: 99, ended_at: 25.days.ago)
    @ended_run_2 = build_stubbed(:ended_run, score: 34.5, ended_at: 23.days.ago)
